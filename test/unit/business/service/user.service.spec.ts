    ...
    describe('create()', () => {
        ...
        describe('When an user already exists with the same unique fields', () => {
            it('should not create and throw an exception ', async () => {
                ...
                const exception =  new BadRequestException('An user with this email or phone already exists.')
        ...
        describe('When an unknow database error occurs', () => {
            it('should not create and throw an exception by checkExists ', async () => {
                repository.checkExists = jest.fn().mockRejectedValueOnce(DatabaseMock.error);
    ...
    describe('findById()', () => {
        ...
        describe('When an unknow database error occurs', () => {
            it('should throw a database error', async () => {
                repository.findOne = jest.fn().mockRejectedValueOnce(DatabaseMock.error);
    ...
    describe('updateById()', () => {
        describe('When an update occurrs successfully', () => {
            it(`should update user's infos`, async () => {
                repository.updateOne = jest.fn().mockResolvedValueOnce(UserMock.response);

                const result = await service.updateById(getId('objectId'), UserMock.request);
        ...
        describe('When an unknow error occurs in database', () => {
            it('should throw a database error', async () => {
                repository.updateOne = jest.fn().mockRejectedValueOnce(DatabaseMock.error);
    ...
    describe('deleteById()', () => {
        describe('when deleting an user by id', () => {
            it('should delete an user successfully', async () => {
                repository.deleteOne = jest.fn().mockResolvedValueOnce(UserMock.response);
    ...
    describe('updatePassword()', () => {
        describe('When update password is successful', () => {
            it(`should update user's password`, async () => {
                ...
                repository.findOne = jest.fn().mockResolvedValueOnce({...rest, password: oldPassword});
        ...
        describe('When current password is wrong', () => {
            it('should throw forbidden exception', async () => {
                const exception = new ForbiddenException('The password informed does not match with current password.');
